...
trait TConnectableCommons extends TMultiPart with IConnectable
{
    ...
    def notifyAllExternals(): AnyVal
    def notifyExternals(mask:Int): AnyVal
...
trait TFaceConnectable extends TConnectableCommons with TFaceAcquisitions
{
    ...
    override def notifyAllExternals(): AnyVal = 
    {
        notifyExternals(0xF)
    }

    override def notifyExternals(mask:Int): AnyVal = 
    {
