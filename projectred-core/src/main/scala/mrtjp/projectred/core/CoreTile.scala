...
//    }
    ...
    def saveToNBT(tag:CompoundNBT): AnyVal = {}

    def loadFromNBT(tag:CompoundNBT): AnyVal =  {}

    def writeDesc(out:MCDataOutput): AnyVal =  {}

    def readDesc(in:MCDataInput): AnyVal =  {}
     ...
     * @param writeFunc
     */
    final def sendUpdate(key:Int, writeFunc:MCDataOutput => Unit): AnyVal =  {
...
trait TTileOrient extends CoreTile {
    ...
    def onOrientChanged(oldOrient: Int): AnyVal = {}
