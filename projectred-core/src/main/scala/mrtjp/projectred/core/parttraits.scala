...
{
    override final def readUpdate(packet:MCDataInput): AnyVal = 
    {
    ...
    override final def sendUpdate(func: Consumer[MCDataOutput]): AnyVal =  {
...
trait TFaceOrient extends TMultiPart with TFacePart
{
    ...
    def onOrientationChanged(oldOrient:Int): AnyVal = {}
