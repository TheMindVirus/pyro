...
object GuiLib
{
    ...
    /**
      ...
      */
    def drawPlayerInvBackground(x:Int, y:Int): AnyVal = 
    {
    ...
    /**
      ...
      */
    def drawSlotBackground(x:Int, y:Int): AnyVal = 
    {
    ...
    /**
      ...
      */
    def drawGuiBox(stack:MatrixStack, x:Int, y:Int, width:Int, height:Int, zLevel:Float): AnyVal = 
    {
    ...
    /**
      ...
      */
    def drawGuiBox(stack:MatrixStack, x:Int, y:Int, width:Int, height:Int, zLevel:Float, top:Boolean, left:Boolean, bottom:Boolean, right:Boolean): AnyVal = 
    {
/*        val u = 1
        val v = 29
