...
//        slot
    ...
    override def addSlotListener(listener:IContainerListener): AnyVal = 
    {
    ...
    override def removeSlotListener(listener:IContainerListener): AnyVal = 
    {
    ...
    override def removed(p:PlayerEntity): AnyVal = 
    {
        super.removed(p)
    ...
    override def setItem(slot:Int, stack:ItemStack): AnyVal = 
    {
...
class Slot3(inv:IInventory, i:Int, x:Int, y:Int) extends Slot(inv, i, x, y) with TSlot3
{
    ...
    override def setChanged(): AnyVal = 
    {
        super.setChanged()
        slotChangeDelegate()
        slotChangeDelegate2()
