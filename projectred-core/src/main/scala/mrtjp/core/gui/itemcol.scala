...
class ItemDisplayNode extends TNode
{
    ...
    override def drawBack_Impl(mStack:MatrixStack, mouse:Point, rframe:Float): AnyVal = 
    {
    ...
    def drawTooltip(mouse:Point): AnyVal = 
    {
...
object ItemDisplayNode
{
    ...
    def renderItem(mStack:MatrixStack, gui:AbstractGui, position:Point, size:Size, zPosition:Double, drawNumber:Boolean, stack:ItemStack): AnyVal = 
    {
