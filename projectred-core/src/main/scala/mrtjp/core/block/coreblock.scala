...
//    def getItemBlockClass: Class[_ <: BlockItem] = classOf[ItemBlockCore] //This is stupidity
//}

//class ItemBlockCore(b: AbstractBlock, properties: Item.Properties) extends BlockItem(b, properties) {
