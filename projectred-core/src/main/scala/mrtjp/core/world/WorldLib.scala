...
//    }
    ...
    def bulkBlockUpdate(world:World, pos:BlockPos, bl:Block): AnyVal = 
    {
    ...
    def dropItem(world:World, pos:BlockPos, stack:ItemStack): AnyVal = 
    {
    ...
    def centerEject(w:World, pos:BlockPos, stack:ItemStack, dir:Int, vel:Double): AnyVal = 
    {
